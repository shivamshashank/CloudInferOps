...
var doctorCmd = &cobra.Command{
	...
	Long:  `Runs diagnostic checks on your OS, hardware resources, network connectivity, and external tools (kubectl, helm, and active Kubernetes context).`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err != nil {
			...
			fmt.Printf("%sRun 'sudo cloudinferops init' to create a custom configuration file.\n\n", utils.PrefixInfo)
